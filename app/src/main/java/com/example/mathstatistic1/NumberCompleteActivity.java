...
public class NumberCompleteActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_number_complete);
    ...
    public void onClick(View v) {
        SolveRow sr = new SolveRow(MyFormat.commaToDot(et1.getText().toString()).split(" "), et2.getText().toString().split(" "));
        sr.convertStringUniqueArrayToDoubleUniqueArray();
        sr.convertStringArrayToIntArray();
        sr.uniqueValToInputedValues();
        sr.sort();
